...
import styles from "/home/harshit/AHMED FE/CodeQuest-frontend/src/pages/CodeRunner.module.css";
...
export default function Problem({ testData }) {
  ...
  if (!questions.length) {
    return <div className={styles.sectionContent}>No questions available.</div>;
  }
    ...
    <div className={styles.problemWrapper}>
      ...
      <div className={styles.questionCard}>
        ...
        <div className={styles.constraintsBox}>
          ...
          <div className={styles.constraintsText}>{currentQuestion.constraints}</div>
        </div>
            ...
            {currentQuestion.testcases.map((tc, i) => (
              <div key={i} className={styles.testCase}>
                <div className={styles.testCaseRow}>
                  ...
                  <span className={styles.testCaseValue}>{JSON.stringify(tc.input)}</span>
                </div>
                <div className={styles.testCaseRow}>
                  <span className={styles.testCaseLabel}>Output:</span>
                  <span className={styles.testCaseValue}>{JSON.stringify(tc.output)}</span>
                </div>
              </div>
            ))}
          </div>
